//setting up the modal so it will pop-up 
var Create_Modal = new bootstrap.Modal(document.getElementById('Create_Modal'), {
  ...
  //showing the whole html code is the setup for the modal.
    let html_body = `
      <div class="card mb-2">
  ...
  //will update your changes to your note. - also called real-time listener 
  ...
  // deleting data - when you click the delete button you should delete the note. 
